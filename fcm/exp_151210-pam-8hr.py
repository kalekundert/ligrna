...
master_sample_dir = '/kortemmelab/data/kyleb/cas9/151210-8hour_pam/96 Well - Flat bottom'
...
plate_1 = Plate([
    ...
    PlateInfo('sgRNA-NAA', None, ['A3', 'A6', 'A9', 'A12']),
    PlateInfo('sgRNA-NGG', None, ['A2', 'A5', 'A8', 'A11']),
    PlateInfo('sgRNA-empty', None, ['A1', 'A4', 'A7', 'A10']),
...
plate_2 = Plate([
    ...
    PlateInfo('sgRNA-NAA', None, ['B3', 'B6', 'B9', 'B12']),
    PlateInfo('sgRNA-NGG', None, ['B2', 'B5', 'B8', 'B11']),
    PlateInfo('sgRNA-empty', None, ['B1', 'B4', 'B7', 'B10']),
], sample_dir = master_sample_dir,
    name = 'replicate_2',
)
...
plate_3 = Plate([
    ...
    PlateInfo('sgRNA-NAA', None, ['C3', 'C6', 'C9', 'C12']),
    PlateInfo('sgRNA-NGG', None, ['C2', 'C5', 'C8', 'C11']),
    PlateInfo('sgRNA-empty', None, ['C1', 'C4', 'C7', 'C10']),
], sample_dir = master_sample_dir,
    name = 'replicate_3',
)
    ...
    for exp in gated_plates:
        ...
        for cas9_name_i, cas9_name in enumerate(cas9_names):
            ...
            for sgrna_name_i, sgrna_name in enumerate(sgrna_names):
                ...
                if this_xmin > xmin:
                    xmin = this_xmin
            ax.set_xlim( (xmin, min(xmax, 20000)) )
