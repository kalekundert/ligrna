...
class PrimerDesigner:
    ...
    def design_inverse_pcr_primers(self):
        ...
        if self.verbose:
            ...
            print("5' overlap GC%:", 100 * gc_percent(overlap_5))
            print("5' overlap len:", len(overlap_5))
            print()
            print("3' overlap:", overlap_3)
            print("3' overlap Tm:", tm_3)
            print("3' overlap GC%:", 100 * gc_percent(overlap_3))
        ...
        name_5 = name + '_{}_TM{:.0f}_REV'.format(date, tm_5)
        name_3 = name + '_{}_TM{:.0f}_FOR'.format(date, tm_3)
    ...
    def design_quikchange_primers(self):
        ...
        if self.verbose:
            ...
            print("best primer GC%:", 100 * gc_percent(best_primer))
...
def report_primers_to_table(primers, key=None):
    if key is None:
        import re
        key = lambda x: re.sub('TM\d{2}', 'TMXX', x)
